...
df = load_competitors_df('../competitors_data.xlsx', brand='BingeTown')
...
#
# nth_day = nth_day_errors_competitors(C_HybridCaster, df, brand='BingeTown', cv = 75)
...
# plt.legend()
# # plt.show()
# plt.savefig('graphs/BingeTown_errors_nth_day_competitors.png')
# plt.clf()
...
relative_error_competitors(C_HybridCaster, brands=['BingeNBash', 'BingeTown'], path='../competitors_data.xlsx',cv=75)